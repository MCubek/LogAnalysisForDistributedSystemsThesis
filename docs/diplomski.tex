...
\section{Lokalna Kubernetes okolina}
...
\hline
logs-cloudvane-*-cloudvane-test & Dnevnički zapisi pojedinog CloudVane mikroservisa \\ 
aggregated-errors & Agregirani dnevnički zapisi grešaka u koje upisuje Kafka Streams aplikacija\\
enriched-errors & Agregirani dnevnički zapisi grešaka sa dodatkom o potencijalnom rješenju u koje upisuje Python servis koji obogaćuje grešku umjetnom inteligencijom\\
